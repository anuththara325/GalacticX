    ...
    with col2:
        ...
        with st.container(border=True, height=400):
            ...
            st.markdown(
                """
            <div style="text-align: center; font-weight: bold;">
                <p style="font-size:20px"><b>Utilize machine learning algorithms to classify galaxies into types such as spiral, elliptical, and irregular based on key features like morphology, brightness, and color.</b></p>
            </div>
            """,
                unsafe_allow_html=True,
            )
    ...
    with col5:
        ...
        with st.container(border=True, height=400):
            ...
            st.markdown(
                """
            <div style="text-align: center; font-weight: bold;">
                <p style="font-size:20px"><b>Dive deep into astronomical knowledge with Astronerd, an advanced AI chatbot powered by state-of-the-art language models. Get instant, accurate responses to your queries about astronomy, astrophysics, and space science.</b></p>
            </div>
            """,
                unsafe_allow_html=True,
            )
...
elif app_mode == "Astronerd Chatbot":
    astro_chatbot()
